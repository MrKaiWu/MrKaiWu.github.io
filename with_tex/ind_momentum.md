...
As we see in **3.1**, industry peers of a focal company come from different SWS Inds. Intuitively, the more related two SWS Inds are, the more likely that they appear simultaneously. There are at least two supporting arguments. First, companies from related Shenwan Industries tend to share similar vocabulary in their reports. Second, for a focal company with diversified businesses, concentric diversification is more likely to happen, in which the company develops products or services closely related with its current core business. 

I first


<img src="/with_tex/tex/095556567c072e456da4db38fc8811c3.svg?invert_in_darkmode&sanitize=true" align=middle width=293.20535145pt height=24.657735299999988pt/>
